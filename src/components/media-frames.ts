...
const DOBRA_MEDIA: Item[] = [
  { src: "/media/dobra-1.png", type: "image", alt: "Dobra — pôster de cor derretida" },
...
// Camada 02 · Quebra — alternância (referências gráficas de alto contraste)
const QUEBRA_MEDIA: Item[] = [
  { src: "/media/quebra-1.png", type: "image", alt: "Quebra — instalação LED tipográfica" },
  { src: "/media/quebra-2.png", type: "image", alt: "Quebra — pôsteres geométricos" },
  { src: "/media/quebra-3.png", type: "image", alt: "Quebra — tipografia em ripas" },
  { src: "/media/quebra-4.png", type: "image", alt: "Quebra — capa geométrica" },
  { src: "/media/quebra-5.gif", type: "image", alt: "Quebra — animação gráfica" },
  { src: "/media/quebra-1.png", type: "image", alt: "Quebra — instalação LED tipográfica" },
  { src: "/media/quebra-2.png", type: "image", alt: "Quebra — pôsteres geométricos" },
  { src: "/media/quebra-3.png", type: "image", alt: "Quebra — tipografia em ripas" },
  { src: "/media/quebra-4.png", type: "image", alt: "Quebra — capa geométrica" },
