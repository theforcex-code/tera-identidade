...
await command('Runtime.evaluate', { expression: `(() => [...document.querySelectorAll('*')].find((el) => el.textContent?.trim() === 'Preto Carvão')?.closest('.grid')?.scrollIntoView({ block: 'center', behavior: 'instant' }))()` });
